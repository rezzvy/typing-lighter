class Model {
  constructor() {
    this.sentences = [
      ...
      ["Matahari terbenam di balik gunung, menyinari dan menciptakan kilauan hangat di danau yang tenang serta memantulkan keindahan alam.", "Anak-anak bermain dengan riang di taman, tawa mereka bergema di udara sembari mereka menikmati kenikmatan sederhana masa kecil.", "Angin sepoi-sepoi melalui dedaunan, menciptakan melodi menenangkan yang membuat dunia terlelap dalam tidur damai.", "Di kota yang sibuk, orang-orang bergegas menjalani hari mereka, setiap orang tenggelam dalam irama kehidupan perkotaan, mengejar impian dan ambisi.", "Saat bintang-bintang berkelap-kelip di langit malam, bulan menjaga bumi, penjaga bisu dari misteri alam semesta.", "Rak buku penuh dengan cerita berdiri di pojok, setiap buku adalah portal ke dunia yang berbeda, menunggu untuk dieksplorasi.", "Aroma kopi segar yang menyapu udara, mengundang semua orang untuk menikmati cita rasa kaya dan menyambut hari yang akan datang.", "Tetesan hujan mengetuk lembut di kaca jendela, menciptakan tarian ritmis yang menenangkan jiwa dan membawa musik alam ke dalam ruangan.", "Di lautan yang luas, ombak bertabrakan dengan pantai, pengingat konstan akan pasang surut kehidupan dan berlalunya waktu.", "Di tengah kekacauan, sebuah bunga mekar, tangguh dan indah, melambangkan harapan dan kemungkinan hari esok yang lebih cerah."],
